...
// GitHub Pages 프로젝트 사이트(/BlessingWorld/ 하위 경로)에서도 깨지지 않도록
// LogoMark.tsx와 같은 방식으로 BASE_URL을 붙인다 — 절대경로("/image/...")는
...
export const HOME_CARDS: HomeCard[] = [
  {
    ...
    to: "/guide",
    cta: "가치 알아보기 →",
    image: IMG("4-home-card-couple.webp"),
  ...
  },
  {
    ...
    to: "/stories",
    cta: "이야기 읽기 →",
    image: IMG("5-home-card-family-home.webp"),
  ...
  },
  {
    badge: "사랑의 기술",
    title: "배울 수 있는 사랑",
    description: "축복결혼을 이해하는 데 도움이 되는 영상 강좌를 모았습니다.",
    to: "/curriculum",
    cta: "강좌 보기 →",
  ...
  },
  {
    ...
    to: "/center",
    cta: "축복센터 가기 →",
    image: IMG("8-home-card-local-church.webp"),
    imageAlt: "지역가정교회 안내",
    size: "sm",
  },
];
