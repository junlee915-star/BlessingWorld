...
export const VALUES_ASSESSMENT_COPY = {
  ...
  /** /values 단독 페이지 전용 안내. 이 페이지의 응답은 어디에도 저장·전송되지 않으므로
   *  embedded용 body("상담 담당자에게만 보이며…")를 그대로 쓰면 사실과 다릅니다. */
  standaloneBody:
    "정답은 없습니다. 지금 드는 방식을 그대로 골라주세요. 이 페이지의 응답은 저장되지 않으며, 화면을 벗어나면 사라집니다. 결과를 상담 담당자에게 전달하려면 축복상담 신청서 안에서 다시 진단하고 첨부해주세요.",
  timeBadge: "총 3분 소요",
